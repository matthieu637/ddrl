#ifndef SIMPLEDENFAC_HPP
#define SIMPLEDENFAC_HPP
...
class SimpleDENFAC : public arch::AACAgent<MLP, arch::AgentGPUProgOptions> {
  public:
    typedef MLP PolicyImpl;

    SimpleDENFAC(unsigned int _nb_motors, unsigned int _nb_sensors);

    virtual ~SimpleDENFAC();
