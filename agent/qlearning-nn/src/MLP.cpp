...
ParallelOptimization::ParallelOptimization(const NN _neural_net, const std::vector<float>& _inputs, const std::vector<float>& _init_search,
...
void ParallelOptimization::operator()(uint thread)
{
