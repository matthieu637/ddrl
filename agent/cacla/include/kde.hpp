...
public: 
    ...
    double pdf(vector<double>& data, const map<int,double>& bandwidth, double factor);
    double cdf(double x);
    ...
    int get_vars_count2(){return(data_matrix[0].size());};
    int get_vars_count3(){return(count_map[0]);};
    const map<int,double>& get_default_bandwidth_map(){return default_bandwidth_map;};
