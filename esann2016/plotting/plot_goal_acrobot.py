...
data_rand = load('../result_data/adacrobot/cl-off.goal.data')
data_human = load('../result_data/adacrobot/cl-on.goal.data') 
data_bootstrap = load('../result_data/adacrobot/random.goal.data')
...
legend = ax.legend(["NFAC", "cacla" , "random"], loc=4);
...
fig.savefig('../result_plotting/adacrobot-1ddl.png', dpi=200)
