...
% \mySugg{}{Il faudrait peut-etre dire plus longuement qu'une methode classique pour l'approximation de la fonction de valeur est d'utiliser une combinaison lineaire de fonction de base, 
% mais qu'il faut alors choisir les fonction de base. D'ou ensuite ta remarque.}
\mytodo{AD}{ $\backslash$mySugg : remove me if ok}
