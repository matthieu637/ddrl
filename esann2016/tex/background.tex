...
about the quality of the \mySugg{action just taken}{state just reached}. The goal of the agent is to maximize
\myCorr{her}{its} long-term expected total reward. Because it is possible that actions associated 
